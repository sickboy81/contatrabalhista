...
const Privacy: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-12">
      <SEO
        title="Política de Privacidade - Conta Trabalhista"
      ...
      <div className="bg-white p-8 md:p-12 rounded-xl shadow-sm border border-slate-200 prose prose-slate max-w-none">
        ...
        <p>O <strong>Conta Trabalhista</strong> tem o compromisso de proteger sua privacidade. Esta política descreve como coletamos, usamos e protegemos suas informações ao utilizar nossas calculadoras e ferramentas.</p>
